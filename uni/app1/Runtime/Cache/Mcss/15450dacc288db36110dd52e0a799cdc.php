...
function afterUpload(){
	...
	if(file){
		var arr = file.split('~');
		file = arr[1];
		$.getJSON("__APP__/System/Model/getSheetNames",{file:file},function(data){
...
function getViewData(){
	$.getJSON("__APP__/System/Model/getViewData",{file:file,sheetname:$("#sheetnames").val()},function(result){
		$.getJSON("__APP__/System/Model/getModelNames",{modelid:modelid},function(data){
			$("#viewData").empty();
...
function readfile(obj){
	try{
		...
		if(getCookie("mcss_impurl") && getCookie("mcss_impurl")!='null')
			...
			url="__APP__/System/Model/xlsTosql";
