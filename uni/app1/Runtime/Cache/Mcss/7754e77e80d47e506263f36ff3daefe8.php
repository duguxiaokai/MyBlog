...
g_remotehome="__APP__/Mcss/Model/";
...
{
	if (!modelid) return;	
		$.getJSON("__APP__/MCSS/Model/getModel",{modelid:modelid},function(data){
...
function loadfromtable()
{
	...
	var url="__APP__/Mcss/Model/getTableFields";
...
function openbase(obj)
{
	...
	ShowIframe("__APP__/mcss/Model/modelmanager/modelid/"+modelid,800,600,"编辑模型");
}
var popp;
...
function get_select_child(obj,fieldid,prop)
{
	...
	$.getJSON("__APP__/MCSS/Model/getModelByPath",{"path":path,"separator":sep},function(data){
		if(data)
		{
...
function savemodel()
{
	...
	$.post(g_remotehome+"saveModel",
		...
		function(data){
			...
			$.getJSON("__APP__/MCSS/Model/getModelByPath",{"filename":filename},function(data){
...
function saveOneModel(createTable,delete_before_create)
{
	...
	$.post(g_remotehome+"saveModelByPath",{modelid:modelid,path:path,modelstr:v,separator:sep,createTable:createTable,delete_before_create:delete_before_create},	function(err){
		...
		{	
			...
			$.getJSON("__APP__/MCSS/Model/getModel",{path:path,modelid:modelid},function(data){
				loadmodel(data,modelid); 
			});
			if (!path)
			{
...
{
	$.getJSON("__APP__/Mcss/Model/getModel",{modelid:$("#model_base").val()},function(data){
		var h="";
...
{
	window.open("__APP__/mcss/Model/help");	
}
