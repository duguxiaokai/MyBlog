...
'filter'=>"cat='周报' and tag=2 and SYS_ORGID=orgid()",
'pagerows'=>"5",
...
'fields'=>array(
 ...
 array('id'=>"finishper",'name'=>"完成状态",'type'=>"radio",'data'=>"0:进行中,1:已完成",'defaultdata'=>"0",'isvisible'=>"true",'visibleWhenAdd'=>"true",),
