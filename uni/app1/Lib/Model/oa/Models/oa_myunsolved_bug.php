...
'filter'=>"(status = '1' or status = '6') and  assign_to=loginuser() ",
'open_window_style'=>"newwindow",
'actions'=>"search,search2,filter,page",
'cols'=>"2",
'fields'=>array(
 array('id'=>"id",'name'=>"字段1",'fieldtype'=>"int",'isvisible'=>"false",'visibleWhenAdd'=>"false",),
 array('id'=>"recordsort",'name'=>"序号",'fieldtype'=>"string",'type'=>"recordindex",'visibleWhenAdd'=>"false",'virtualfield'=>"true",),
 ...
 array('id'=>"SYS_EDITUSER",'name'=>"更新者",'fieldtype'=>"string",'type'=>"SYS_ADDUSER",'data'=>"sql:select a.name,  b.name as staffusername   from sys_user a left join sys_staff b on   b.username=a.name where a.orgids like   '%orgid()%' order by staffusername",'visibleWhenAdd'=>"false",'readonly'=>"true",),
