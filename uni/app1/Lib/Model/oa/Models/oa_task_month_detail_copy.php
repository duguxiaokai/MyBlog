...
'fields'=>array(
 ...
 array('id'=>"executerid",'name'=>"执行人",'type'=>"dropdown",'data'=>"sql:select id,name from sys_staff where SYS_ORGID=orgid()",'defaultdata'=>"Me()",),
 array('id'=>"finishper",'name'=>"完成状态",'type'=>"radio",'data'=>"0:进行中,1:已完成,2:取消",'defaultdata'=>"0",),
 array('id'=>"begindate",'name'=>"开始日期",'type'=>"date",),
 array('id'=>"enddate",'name'=>"结束日期",'type'=>"date",),
