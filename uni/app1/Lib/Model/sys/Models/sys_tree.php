...
'fields'=>array(
 ...
 array('id'=>"parentid",'name'=>"上级目录",'type'=>"dropdown",'data'=>"sql:select id,name from sys_tree where type='info'",),
 array('id'=>"name",'name'=>"目录名称",),
 array('id'=>"type",'name'=>"类别",'isvisible'=>"false",'visibleWhenAdd'=>"false",),
