...
'pagerows'=>"10",
'actions'=>"del,search,search2,page",
'cols'=>"2",
'fields'=>array(
 array('id'=>"id",'name'=>"ID",'fieldtype'=>"int",'isvisible'=>"false",'visibleWhenAdd'=>"false",),
 array('id'=>"stat_name",'name'=>"统计名称",'fieldtype'=>"string",'isvisible'=>"false",'visibleWhenAdd'=>"false",'forsearch'=>"true",),
 array('id'=>"stat_code",'name'=>"统计类别",'fieldtype'=>"string",'isvisible'=>"false",'visibleWhenAdd'=>"false",'forsearch'=>"true",),
 array('id'=>"owner",'name'=>"统计者",'fieldtype'=>"string",'isvisible'=>"false",'visibleWhenAdd'=>"false",'forsearch'=>"true",),
 ...
 array('id'=>"cost_time",'name'=>"耗费时间(秒)",'fieldtype'=>"real",'isvisible'=>"true",'visibleWhenAdd'=>"true",),
),
