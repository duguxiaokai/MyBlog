...
'fields'=>array(
 ...
 array('id'=>"projectid",'name'=>"项目",'fieldtype'=>"int",'data'=>"sql:select id,name from oa_project",'visibleWhenAdd'=>"false",),
 ...
 array('id'=>"status",'name'=>"状态",'fieldtype'=>"string",'type'=>"dropdown",'data'=>"plan:计划,doing:执行,done:完成,better:优化,checked:验收,cancel:取消",'visibleWhenAdd'=>"false",),
