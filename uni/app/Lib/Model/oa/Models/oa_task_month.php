...
'filter'=>"(executerid=Me() and cat='日报') or ((SYS_ADDUSER=loginuser() or executerid=Me()) and (cat='周报' or cat='月报')) and tag=2 and SYS_ORGID=orgid()",
'pagerows'=>"6",
...
'fields'=>array(
 ...
 array('id'=>"begindate",'name'=>"开始日期",'width'=>"300px",),
 array('id'=>"enddate",'name'=>"结束日期",'width'=>"300px",),
 array('id'=>"executerid",'name'=>"执行人",'type'=>"dropdown",'data'=>"sql:select id,name from sys_staff where SYS_ORGID=orgid()",'width'=>"300px",),
 array('id'=>"name",'name'=>"主题",'nullable'=>"false",'width'=>"300px",),
 array('id'=>"finishper",'name'=>"完成状态",'fieldtype'=>"string",'type'=>"radio",'data'=>"0:进行中,1:已完成",'defaultdata'=>"0",),
 array('id'=>"tag",'name'=>"标签",'type'=>"dropdown",'data'=>"1:计划概述,2:工作条目,3:总结",'defaultdata'=>"1",'isvisible'=>"false",'visibleWhenAdd'=>"false",'width'=>"300px",),
