...
'filter'=>"status = '2'  and  assign_to=loginuser() ",
'orderby'=>"SYS_EDITTIME desc",
'open_window_style'=>"newwindow",
'actions'=>"search,filter,page",
'cols'=>"2",
...
'fields'=>array(
 ...
 array('id'=>"begindate",'name'=>"计划开始日期",'fieldtype'=>"date",'type'=>"date",'isvisible'=>"false",),
 array('id'=>"dealline",'name'=>"计划完成日期",'fieldtype'=>"date",'type'=>"date",'isvisible'=>"false",),
),
