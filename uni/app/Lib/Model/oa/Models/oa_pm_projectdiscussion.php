...
'title'=>"项目讨论",
'base'=>"oa_discussion",
'sql'=>"select a.*,(select name from oa_task where id=a.task_id) as taskname from oa_discussion a",
...
'fields'=>array(
 ...
 array('id'=>"taskname",'name'=>"任务名称",'isvisible'=>"false",'visibleWhenAdd'=>"false",'virtualfield'=>"true",),
