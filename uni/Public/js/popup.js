...
//这是MCSS框架添加的代码，定义在风格目录下Public\themes\yellow1\js\theme.js
if (!theme_popup_title_bgcolor)
{
...
var path ="/Public/themes/"+theme+"/images/dialogclose.png";
importJS("themes/"+theme+"/js/theme.js");
...
Popup.prototype = {
    ...
    initialize: function(config) {
        ...
        this.color = {
            cColor: "#000000",
            bColor: "#FFFFFF",
            tColor: theme_popup_title_bgcolor,//标题栏背景色,"#709CD2"
            wColor: "#fff"
        };
        this.dropClass = null;
        this.someToHidden = [];
    ...
    build: function() {
        ...
        //var path = "http://img.baidu.com/hi/img/dialogclose.gif";
		//path变量放在上边了。
       // var close1 = '<input type="image" id="dialogBoxClose1" src="' + getrooturl()+path + '" width="18" height="18" align="absmiddle" title="关闭" style="border:none"/>';
		var close = '<a class="closedialog" id="dialogBoxClose"  align="absmiddle" title="关闭"><i class="i-pop-close"> </i></a>';
        //var close = '<span id="dialogBoxClose" width="16" height="16" align="absmiddle" title="关闭" style="cursor:pointer;color:red;font-size:15px;">Ⅹ</span>';
        //var close1 = '<span id="dialogBoxClose1" width="10" height="16" align="absmiddle" title="关闭"  style="cursor:pointer;color:red;font-size:15px;">Ⅹ</span>';
        var cB = 'filter: alpha(opacity=' + this.info.coverOpacity + ');opacity:' + this.info.coverOpacity / 100 + ';';
        var cover = '<div id="dialogBoxBG" style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:' + baseZIndex + ';' + cB + 'background-color:' + this.color.cColor + ';display:none;"></div>';
        var mainBox = '<div id="dialogBox" class="dialogBoxbordercolor" style="display:none;z-index:' + showZIndex + ';position:relative;width:' + this.config.width + 'px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="' + this.color.bColor + '">';
        if (this.config.isHaveTitle) {
            mainBox += '<tr height="24" class="popupheadbg"><td><table style="-moz-user-select:none;height:24px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr><td id="dialogClose" width="5px" align="left" valign="middle"></td><td width="6" height="24"></td><td id="dialogBoxTitle" class="dialog_title_txt">' + this.info.title + '&nbsp;</td><td id="dialogClose" width="20" align="right" valign="top">' + close + '</td><td width="6px" ></td></tr></table></td></tr>';
            //<td width="6px" onclick="dialogBox.width=900px;window.open(g_pop.info.contentUrl);" style="cursor:pointer;" title="新窗口">【】</td>  //陈坤极
        } else {
            mainBox += '<tr height="10"><td align="right">' + close + '</td></tr>'
        };
        mainBox += '<tr style="height:' + this.config.height + 'px" valign="top"><td id="dialogBody" style="position:relative;"></td></tr></table></div><div id="dialogBoxShadow" class="dialogBoxShadowbg" style="display:none;z-index:' + baseZIndex + ';"></div>';
       ...
       // Event.observe(G('dialogBoxClose1'), "click", this.reset.bindAsEventListener(this), false);
    ...
    lastBuild: function() {
        var confirm = '<div style="width:100%;height:100%;text-align:center"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">' + this.info.confirmCon + '</div><div style="margin:20px;"><input id="dialogOk" type="button" class="btn" value=" 确定 "/>&nbsp;<input id="dialogCancel" type="button" class="btn" value=" 重置 "/></div></div>';
    ...
    shadow: function() {
		...
		var bgTop=oDialog.offsetTop + this.info.shadowWidth -10;
		var bgLeft=oDialog.offsetLeft + this.info.shadowWidth -10;
        oShadow['style']['top'] =  bgTop+ "px";
        oShadow['style']['left'] = bgLeft + "px";
		var bgwidth=oDialog.offsetWidth+12;var bgheight=oDialog.offsetHeight+12;
        oShadow['style']['width'] = bgwidth + "px";
        oShadow['style']['height'] = bgheight + "px";
    },
    middle: function() {
...
Dragdrop.prototype = {
    ...
    mousemove: function(event) {
        ...
        if (this.showShadow) {
            G('dialogBoxShadow').style.left = iLeft + this.shadowWidth - 10 + "px";
            G('dialogBoxShadow').style.top = iTop + this.shadowWidth - 10 + "px"
        };
        this.dragData = {
            x: Event.pointerX(event),
            y: Event.pointerY(event)
